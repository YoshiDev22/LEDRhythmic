...
pinMode (nLEDs[0],OUTPUT); // PIN DEL LED1
pinMode (nLEDs[1],OUTPUT); // PIN DEL LED1
pinMode (nLEDs[2],OUTPUT); // PIN DEL LED1
pinMode (nLEDs[3],OUTPUT); // PIN DEL LED1
pinMode (btn, INPUT); // BOTON PARA INICIAR LAS CANCIONES 
}

void blinkLED(int nLED){
  state=!state;
  digitalWrite(nLEDs[nLED],state);
  nLED+=1;
  digitalWrite(nLEDs[nLED],state);
}
